...
/**
 * Classe responsável por criar a tela de consulta de Vendedores cadastrados
 * 
...
public class ConsultarVendedorView {
	...
	private String colunas[] = { "Nome", "Área de Venda", "Cidade", "Estado", "Sexo", "Idade", "Salario" };
	...
	/*
	 * Método responsável por carregar a tabela com os dados dos vendedores gravados
	 * no arquivo txt
	 */
